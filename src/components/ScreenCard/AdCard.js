...
function AdCard() {
    return (
        <div class=''>
            <div class="sm:text-sm shadow-white lg:w-64 lg:text-md  sm:w-40 max-w-sm overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <div class=" sm:w-40 fixed shadow-white lg:w-64 lg:text-md  sm:text-sm mt-10  max-w-sm   bg-white rounded-lg shadow-sm dark:bg-gray-800">
