                ...
                <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                    <div class="text-white lg:w-1/2 lg:mx-6">
                        ...
                        <div class="mt-6 space-y-8 md:mt-8">
                            ...
                            <p class="flex items-start -mx-2">
                                ...
                                <span class="mx-2 text-white truncate w-72">(555) 555-33-55</span>
                            </p>
                            ...
                            <p class="flex items-start -mx-2">
                                ...
                                <a  href="mailto:bedirhankabatas1@gmail.com" class="mx-2  text-white truncate w-72">bedirhankabatas1@gmail.com</a>
                            </p>
                        </div>

                        <div class="mt-6 md:mt-8">
                            <h3 class="text-gray-300 ">Bizleri Takip Edin</h3>
                    ...
                    <div class=" lg:w-1/2 lg:mx-8">
                        <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                            <h1 class="text-xl font-medium text-gray-700 dark:text-gray-200">Giriş Ekranı</h1>

                            <form class="mt-4">
                                <div class="flex-1">
                                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email Adresiniz</label>
                                    <input type="email" placeholder="example@example.com" class="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                </div>

                                <div class="flex-1 mt-6">
                                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Şifreniz</label>
                                    <input type="password"  class="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                </div>
                                ...
                                <p class="mt-4 text-white">Şifrenizi mi unuttunuz? <span class="underline text-blue-600 cursor-pointer">Şifrenizi değiştirin</span> </p>

                                <p class="mt-4 text-white">Hesabınız yok mu ? <span class="underline text-blue-600 cursor-pointer">Kayıt olun</span> </p>
                            </form>
                        </div>
                    </div>
                </div>
